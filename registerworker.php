                ...
                <div class="pl-lg-4">
                  <div class="row">
                    <div class="col-md-3">
                      ...
                      <div class="col-md-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-id">Hostel Name  <span class="text-danger">*</span></label>
                        <input type="text" name="regHostel" id="input-id" class="form-control" required placeholder="Hostel Name">
                      </div>
		    </div>
