...
<html lang="en">
<head>
  <title>Register User - Housekeeper Admin Dashboard</title>
      ...
      <div class="row mt-2">
        <div class="col-xl-12 order-xl-1">
          <div class="card bg-secondary shadow">
                  ...
                  <div class="row">
                    <div class="col-md-3">
                      <div class="form-group">
                        <label class="form-control-label" for="input-id">UserID <span class="text-danger">*</span></label>
			...
			<input type="password" name="regPass" id="input-id" class="form-control" required placeholder="Enter User password">
                      </div>
                    </div>
                      ...
                      <div class="form-group">
                        ...
                        <input type="text" name="regHostel" id="input-id" class="form-control" required placeholder="Enter User Hostel">
                      </div>
                    </div>
